...
final class Bank_Mellat_Settings extends \DediData\Singleton {
	...
	public function admin_menu() {
		add_submenu_page( 'bank-mellat', __( 'Settings', 'bank-mellat' ), __( 'Settings', 'bank-mellat' ), 'manage_options', 'WPBEGPAY-settings', array( $this, 'settings' ) );
	}
	...
	public function settings() {
		...
		<div class="wrap">
			<?php 
				...
				// settings_errors(); 
			?>
 			<h2><?php _e( 'تنظیمات افزونه پرداخت آنلاین', 'bank-mellat' ); ?></h2>
			...
			<?php
				...
				$settings = get_option( 'WPBEGPAY_settings_fields_arrays', $setting_default_values );
